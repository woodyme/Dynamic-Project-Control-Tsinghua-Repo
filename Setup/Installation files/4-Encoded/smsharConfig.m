...
(* engine bound paths *)
epsrSMSHARData = FileNameJoin[{$RootDirectory,"Users",$UserName,"Dropbox","SMSHAR World","SMSHARDATA"}];
epsrDomainsPath = FileNameJoin[{$RootDirectory,"Users",$UserName,"Dropbox","Public","SMSHAR"}];
...
smshTimeLimit = 40;
smshAccessToken = "34dm3nqio3py0615384wfa4a5v";
smshAccSheetID = "1112267514242948";
(*smshProjSheetID = "8457005187786628";*)
